...
TESTDIR = /homes/80/valentinm/images
BASE_FLAGS=-it --rm -v ${PWD}:/home/$(MYUSER) -v $(DATADIR):/home/$(MYUSER)/data -v $(TESTDIR):/home/$(MYUSER)/images --shm-size 40G -p 8082:80 -p 8085:6006
RUN_FLAGS=$(GPUS) $(BASE_FLAGS)

DOCKER_IMAGE_NAME = abides
...
# make file commands
build:
	DOCKER_BUILDKIT=1 docker build -f Dockerfile_clpc --build-arg USE_CUDA=$(USE_CUDA) --build-arg MYUSER=$(MYUSER) --build-arg UID=$(ID) --tag $(IMAGE) --progress=plain ${PWD}/. 
